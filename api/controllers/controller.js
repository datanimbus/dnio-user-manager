...
router.get('/validate', mapSwaggerParams, UserController.validateUserSession);
router.get('/check', mapSwaggerParams, UserController.checkUserSession);
router.get('/extend', mapSwaggerParams, UserController.extendSession);
router.get('/refresh', mapSwaggerParams, UserController.refreshToken);
router.get('/config', mapSwaggerParams, ConfigController.index);
router.get('/config/:id', mapSwaggerParams, ConfigController.show);
router.get('/app', mapSwaggerParams, AppController.index);
router.post('/app', mapSwaggerParams, AppController.create);
...
router.post('/app/:app/bookmark', mapSwaggerParams, BookmarkController.create);
router.get('/app/:app/bookmark', mapSwaggerParams, BookmarkController.customIndex);
